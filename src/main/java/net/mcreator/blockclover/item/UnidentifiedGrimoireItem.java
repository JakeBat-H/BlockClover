...
import net.mcreator.blockclover.procedures.UnidentifiedGrimoireRightClickedInAirProcedure;
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				UnidentifiedGrimoireRightClickedInAirProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
