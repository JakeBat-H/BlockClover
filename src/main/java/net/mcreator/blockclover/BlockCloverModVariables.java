...
public class BlockCloverModVariables {
	public BlockCloverModVariables(BlockCloverModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("block_clover", "player_variables"), new PlayerVariablesProvider());
	}
